...
final class AsyncPlateStore {
    ...
    AsyncPlateStore(BmwSpeed plugin, File file, Supplier<Map<UUID, String>> snapshotSupplier) {
        this.plugin = plugin;
        this.file = file;
    ...
    private void writeSnapshot() {
        ...
        try {
            ...
            plugin.getLogger().severe("无法保存 plates.yml：" + exception.getMessage());
        } finally {
            fileLock.unlock();
        }
    }
